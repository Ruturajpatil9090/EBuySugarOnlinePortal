      ...
      <SidebarContainer>
        ...
        <SlickBar clicked={click}>
          ...
          >
            ...
            <Text clicked={click}>E Tender</Text>
          </Item>
          ...
          >
            ...
            <Text clicked={click}>My Orders</Text>
          </Item>
          <Item
            onClick={() => setClick(false)}
            activeClassName="active"
          ...
          >
            ...
            <Text clicked={click}>My Reports</Text>
          </Item>
          <Item
            onClick={() => setClick(false)}
            activeClassName="active"
        ...
        <Profile clicked={profileClick}>
          ...
          <Details clicked={profileClick}>
            <Name>
              <h6>{userId}{firstName}</h6>
              <a href="">view&nbsp;profile</a>
            </Name>

            <Logout>
              <img src={PowerOff} onClick={handleLogoutCliked} alt="logout" style={{ backgroundColor: "red" }} />
            </Logout>
          </Details>
        </Profile>
      </SidebarContainer>

...
import OpenUserBidOpenPopup from './OpenUserBidOpenPopup';
import OpenAdminBidOpenPopup from './OpenAdminBidOpenPopup';
import { EditIcon, DeleteIcon } from '@chakra-ui/icons';
import Button from '@mui/material/Button';
import OpenEditETenderPopUp from './OpenEditETenderPopUp';
...
const OpenPublishETender: React.FC = () => {
    ...
    const fetchTenders = async () => {
        try {
            ...
            const data: Tender[] = response.data.filter((tender: Tender) => tender.Tender_Type === 'O');
            setTenders(data);
        } catch (err: any) {
                ...
                <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="right">Open Including GST Rate</TableCell>
                        ...
                        {paginatedTenders.length === 0 ? (
                            ...
                            paginatedTenders.map((tender) => (
                                <TableRow key={tender.MillTenderId}>
                                    ...
                                    <TableCell align="right">{tender.Open_Rate_Including_GST}</TableCell>
...
export default OpenPublishETender;
